return {
  {
    ...
    config = function()
      ...
      require('mason-lspconfig').setup {
        -- This ensures the servers you list in the 'servers' table are installed
        ensure_installed = vim.tbl_keys(servers),

        -- The setup logic now goes inside this 'handlers' table
        handlers = {
          function(server_name)
            local server_opts = servers[server_name] or {}

            -- This is the same logic as before, just nested correctly
            server_opts.on_attach = function(_client, bufnr)
